            ...
            <div className="flex items-center py-4 justify-between gap-4 flex-col sm:flex-row">
                ...
                <div
                    ...
                    <Input
                        ...
                        className="w-full placeholder:text-slate-400 bg-gray-50 border-none text-light-text focus:ring-primary-600 focus:border-primary-600 block w-full dark:bg-gray-700 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    />
                </div>
            </div>
