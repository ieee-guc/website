...
export default function SideBar() {
    ...
    return (
        <>
            <div className={`flex flex-col items-center ${isOpen ? 'w-40' : 'w-16'} overflow-hidden text-light-text dark:text-dark-text bg-light-sub-bg dark:bg-dark-sub-bg rounded-r-xl h-dvh fixed group`}>
                ...
                <div className="w-full px-2">
                    <div className="flex flex-col items-center w-full mt-3 border-t border-gray-700">
                        <a className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-700 hover:text-gray-300" href="#">
                            ...
                            {isOpen && <span className="ml-2 text-sm font-medium ">Dasboard</span>}
                        </a>
                        <a className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-700 hover:text-gray-300" href="#">
                            <svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
