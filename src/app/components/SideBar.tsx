        ...
        <div className="relative">
            ...
            <div className={`flex flex-col items-center z-50 ${isOpen ? 'w-44' : 'w-16'} transition-all duration-300 text-light-text dark:text-dark-text bg-light-sub-bg dark:bg-dark-sub-bg rounded-r-xl h-dvh fixed`}>
                ...
                <div className="w-full px-2">
                    <div className="flex flex-col items-center w-full mt-3 border-t border-light-border dark:border-dark-border align-middle">
                        <a className="relative group flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-light-border dark:hover:bg-dark-border" href="/director/dashboard">
                            ...
                            {!isOpen && <span className="absolute left-10 opacity-0 bg-light-border dark:bg-dark-border group-hover:opacity-100 h-12 p-4 rounded ">Dashboard</span>}
                        ...
                        <a className="relative group flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-light-border dark:hover:bg-dark-border" href="#">
                            ...
                            {!isOpen && <span className="absolute left-10 opacity-0 bg-light-border dark:bg-dark-border group-hover:opacity-100 h-12 p-4 rounded ">Search</span>}
                        ...
                        <a className="relative group flex items-center w-full h-12 px-3 mt-2 bg-light-border dark:bg-dark-border rounded" href="#">
                            ...
                            {!isOpen && <span className="absolute left-10 opacity-0 bg-light-border dark:bg-dark-border group-hover:opacity-100 h-12 p-4 rounded ">Insights</span>}
                        ...
                        <a className="relative group flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-light-border dark:hover:bg-dark-border" href="#">
                            ...
                            {!isOpen && <span className="absolute left-10 opacity-0 bg-light-border dark:bg-dark-border group-hover:opacity-100 h-12 p-4 rounded ">Docs</span>}
                    ...
                    <div className="flex flex-col items-center w-full mt-2 border-t border-light-border dark:border-dark-border">
                        <a className="relative group flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-light-border dark:hover:bg-dark-border" href="#">
                            ...
                            {!isOpen && <span className="absolute left-10 opacity-0 bg-light-border dark:bg-dark-border group-hover:opacity-100 h-12 p-4 rounded ">Products</span>}
                        ...
                        <a className="relative group flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-light-border dark:hover:bg-dark-border" href="#">
                            ...
                            {!isOpen && <span className="absolute left-10 opacity-0 bg-light-border dark:bg-dark-border group-hover:opacity-100 h-12 p-4 rounded ">Settings</span>}
                        ...
                        <a className="relative group flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-light-border dark:hover:bg-dark-border" href="#">
                            ...
                            {!isOpen && <span className="absolute left-10 opacity-0 bg-light-border dark:bg-dark-border group-hover:opacity-100 h-12 p-4 rounded ">Messages</span>}
                ...
                <a className="relative group flex items-center justify-center w-full h-16 mt-auto  hover:bg-light-border dark:hover:bg-dark-border" href="#">
                    ...
                    {!isOpen && <span className="absolute left-12 opacity-0 bg-light-border dark:bg-dark-border group-hover:opacity-100 h-16 p-4 rounded ">Account</span>}
