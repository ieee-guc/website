                ...
                <div className="rounded-xl bg-light-bg dark:bg-dark-bg shadow-lg z-10 sm:w-3/5 w-full m-auto p-8 sm:p-16 h-fit flex flex-col space-y-2">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-end mt-0">
                        <input
                            ...
                            name="email"
                            id="email"
                            className="text-sm sm:text-lg bg-gray-50 border border-gray-300 text-light-text rounded-xl focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="Enter your email"
                        />
                        <button className="min-w-40 float-right w-1/4 m-2 bg-light-primary p-2 text-dark-text rounded overflow-hidden signin-button">
                            Subscribe
                            <ChevronsRight
